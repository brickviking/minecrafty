...
\shead{SYNOPSIS}
\begin{TPlist}{}
  \item[{\bf minecrafty \  [-hvacTSBEOP]}
    {\bf [-b\ }{\it n.n}{\bf ]}
    {\bf [-g\ }{\it n.n}{\bf ]}
    {\bf [-m \  0$|$1$|$2]}
    {\bf [-r\ }{\it nn.n}{\bf ]}
    {\bf [-z\ }{\it XxY}{\bf ]\ ...}]
  \item[{{\bf minecrafty}{\it \ }{\bf [-f\ }{\it launcher\_name$|$help}{\bf ]\ ...}}]
  \item[{{\bf minecrafty}{\it \ }{\bf [-l\ }{\it launcher\_name$|$help}{\bf ]\ ...}}]
  \item[{{\bf minecrafty}{\it \ }{\bf [-s}{\it \ servername}{\bf ]\ ...}}]
\end{TPlist}
...
% |name|meaning|
    {\begin{TPlist}{}
      \item[{\bf default}]
      \item[{\bf launcher}]
      \item[{\bf vanilla}] run default launcher
      \item[{{\bf atl}}] run AT Launcher
      \item[{{\bf ftb}}] run FTB launcher
      \item[{{\bf magic}}] run MagicLauncher
      \item[{{\bf multi}}] run MultiMC
      \item[{{\bf technic}}] run Technic launcher
      \item[{{\bf terra}}] run TerraFirmaCraft launcher (1.7.10 only)
      \end{TPlist}
    }
% ### Obsoleted entries ###
% .TP
...
starts
{\it \$\{HOME\}/.minecraft/server/server\_name.jar ,}
